...
import { getUserItemReservations, addReservation, deleteReservation, pullReservations, getAllReservationsWithDetails } from '../database.js';
...
router.post("/reservations", async (req: Request, res: Response) => {
    ...
    const { cabin_id, resource_id, staff_id, start_time, end_time } = req.body;
